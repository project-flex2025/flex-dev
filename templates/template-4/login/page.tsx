...
const Login = () => {
    return (
        <div className="container-fluid login-variant-4">
            <div className="logo-section">
                {/* <Image  src="" alt="Login Logo"> */}
                <Image src={`/${LoginJson.imgURL}`} alt='logo' width={150} height={50} />
            </div>

            <div className="container login-main-section">
                <div className="login-container">
                    <h6 className="text-muted">Welcome to <span className='brand-name'>{LoginJson.companyName}</span></h6>
