                ...
                <div className="row">
                    <div className="col-lg-6 col-md-12 d-flex justify-content-center">
                        <div className="login-section">
                            <div className="logo-section">
                                <Image src={`/${LoginJson["Company Logo"].value}`} alt="login logo" width={200} height={50} />
                            </div>
                            <h3 className="login-head">Sign in</h3>
                            <p className="login-title text-muted">{LoginJson["Company Name"].value}</p>
                    ...
                    <div className="col-lg-6 col-md-12 login-right-section">
                        <div className="login-img-section">
                            <Image src={`/${LoginJson["Login Side Image"].value}`} className="login-img" alt="login-img" width={200} height={50} />
                            <div className='login-right-content'>
                                <h4>Sign in to {LoginJson["Company Name"].value}</h4>
